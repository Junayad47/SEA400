...
def highestGPA(semGradeList, astudent):
    ...
    "*** YOUR CODE HERE ***"
    maxGPA = 0
    for semester in semGradeList:
        gpa = astudent.getGPA(semester)
        if gpa > maxGPA:
            maxGPA = gpa
    return maxGPA
...
if __name__ == '__main__':
    ...
    print("GPA for semester 1 for", std.name, "is", std.getGPA(semester1))
    #print("GPA for semester 2 for", 
    print("GPA for semester 2 for", std.name, "is", std.getGPA(semester2))
